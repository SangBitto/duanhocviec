...
const btnOpenb = document.querySelector(".headerab__menu--icon");
const listMenub = document.querySelector(".headerab__menu--nav");
const btnCloseb = document.querySelector(".menu__close");
const overlayb = document.querySelector(".headerab__menu--overlay");
